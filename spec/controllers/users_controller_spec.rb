...
describe UsersController do
  ...
  describe "GET 'index'" do
    ...
    describe "for signed-in users" do
      before(:each) do
        @first=test_sign_in(Factory(:user))
  ...
  describe "GET 'show'" do
    ...
    it "should find the right user" do
      get :show ,:id=>@user
      assigns(:user).should==@user     # return the value of the corresponding instance variable
                                       #in the controller action =>'@user' in 'show' action
    end
    it "should have the right title" do
      get :show ,:id=>@user
    ...
    it "should show the user's microposts" do
      mp1=Factory(:micropost, :user=>@user, :content=>"lala lala")
      mp2=Factory(:micropost, :user=>@user, :content=>"Foobar foobar")
      get :show, :id=>@user
  ...
  describe "POST 'create'" do
    ...
    describe "success" do
      before(:each) do
        @attr={:name=>"Michael Tsai" ,:email => "Michael@example.com" ,
                                      :password => "foobar" ,
  ...
  describe "DELETE 'destroy'" do
    ...
    describe "as an admin user" do
      ...
      it "should not destroy admin himself" do
        lambda do
