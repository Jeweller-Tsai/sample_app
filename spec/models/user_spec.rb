...
describe User do
  ...
  it "should reject invalid email addersses" do
  ...
  it "should reject duplicate email addresses" do
    # put a user with given email into db.
    #Note that Rails tests are transactional:
    #each test is wrapped in a transaction,
    #which rolls back the database after the test executes
    User.create!(@attr)
    user_with_duplicate_email=User.new(@attr)
    user_with_duplicate_email.should_not be_valid
  end

  it "should reject email addersses identical up to case" do
  ...
  describe "micropost associations" do
    ...
    describe "status feed" do
      ...
      it "should inlude the user's microposts" do
